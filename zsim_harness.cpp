...
void LaunchProcess(uint32_t procIdx) {
    ...
    if (cpid) { //parent
        ...
        const char* abc[1];
        abc[0] = "/work2/z50038971/dynamorio/clients/drpin/executables/drpin -t /work2/z50038971/zsim/build/opt/libzsim.so -- ls 2>&1 | tee ./output_stdout/_work2_z50038971_zsim_build_opt_libzsim_so.txt";
        std::cout<<abc[0]<<std::endl;
        std::cout<<(char* const*)abc<<std::endl;
